...
\bibitem{ad1} Hyoungju Ji,``Introduction to Ultra Reliable and Low Latency Communications in 5G'', arXiv:1704.05565v3.
\bibitem{b2} G. Berardinelli, ``Enabling early HARQ feedback in 5G networks,'' 2016 IEEE 83rd Vehicular Technology Conference (VTC Spring), pp. 1–5, May 2016.
\bibitem{ad5} Trung-Kien Le, ``Control and data channel combining for reliability enhancement in Ultra-reliable and low-latency communication's downlink transmission,'' 2019 IEEE 53rd International Conference on Communications, May 2019.
\bibitem{b1} R1-1719406,``PDCCH reliability for URLLC'', Huawei, HiSilicon, RAN1\#91, Reno, USA, Nov 27--Dec1, 2017.
\bibitem{b5} R1-1715529,``Ultra-reliable part of URLLC for scheduling and HARQ procedure'', ZTE, Sanechips, RAN1 Ad Hoc\#3, Nagoya, Japan, Sept 18--21, 2017.
\bibitem{b4} R1-1716248,``Reliable PDCCH operation for NR'', Sony, RAN1 Ad Hoc\#3, Nagoya, Japan, Sept 18--21, 2017.
\bibitem{b7} R1-1701595,``Analysis of URLLC reliability for HARQ'', ZTE, ZTE Microelectronics, RAN1\#88, Athens, Greece, Feb 13--17, 2017.
...
\bibitem{ad4} Chairman's Notes RAN1 \#90.
